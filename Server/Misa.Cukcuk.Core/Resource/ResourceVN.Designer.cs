...
namespace Misa.Cukcuk.Core.Resource {
    ...
    public class ResourceVN {
        ...
        public static string EmployeeCode_IsExisted {
            get {
                return ResourceManager.GetString("EmployeeCode_IsExisted", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Có lỗi xảy ra, vui lòng liên hệ bộ phận kỹ thuật để được hỗ trợ..
        /// </summary>
